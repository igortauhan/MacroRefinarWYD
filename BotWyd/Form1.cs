...
namespace BotWyd
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Para gravar as coordenadas de onde você deixar a PL na mochila, aperte END.\n" +
                "Para gravar as coordenadas do item que você quer refinar, aperte HOME\n" +
